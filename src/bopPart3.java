...
public class bopPart3 {
    public static void main(String[] args) {
        ...
        int strengthTraining = sc.nextInt();

        System.out.println("You did " + totalMinutes + " minutes " + activityLevel + " exercise during week.\n");

        if(activityLevel.equals("vigorous") && totalMinutes >=75 || activityLevel.equals("moderate") && totalMinutes >= 150 && strengthTraining>= 2){
